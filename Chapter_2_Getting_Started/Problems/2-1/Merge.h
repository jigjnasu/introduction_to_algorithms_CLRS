...
/*
  Time complexity of Merge Sort is O(nlg(n)).
 */

#ifndef DATA_STRUCTURE_CHAPTER_2_MERGE_H_
#define DATA_STRUCTURE_CHAPTER_2_MERGE_H_
...
#endif // DATA_STRUCTURE_CHAPTER_2_MERGE_H_
